...
copyright = u'{{ cookiecutter.copyright_year }}, {{ cookiecutter.author_full_name }} - {{ cookiecutter.company_name }}'
...
latex_documents = [
    (
        ...
        u'{{ cookiecutter.author_full_name }}', 'manual',
    ),
]
...
man_pages = [
    (
        ...
        u'{{ cookiecutter.project_name }} Documentation',
        [u'{{ cookiecutter.author_full_name }}'], 1,
    ),
]
...
texinfo_documents = [
    (
        'index', '{{ cookiecutter.project_slug }}',
        u'{{ cookiecutter.project_name }} Documentation',
        u'{{ cookiecutter.author_full_name }}',
